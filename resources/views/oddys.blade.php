					...
					@foreach($oddys as $oddy)
						<li>
							<div class="abstract">
								...
								@auth()
									<a href="{{Route('oddys.edit', $oddy)}}">			Редактировать</a>
