<header class="bg-light">
			...
			@auth()
				<div class="admin-btn">
					<a href="{{Route('locations.create')}}"><li @class(['navlink', 'admin-link', 'navlinkactive'=>request()->routeIs('locations.create')])>Добавление площадки</li></a>
					<a href="{{Route('oddys.create')}}"><li @class(['navlink', 'admin-link', 'navlinkactive'=>request()->routeIs('oddys.create')])>Добавление одиссеи</li></a>
				</div>
			@endauth
			<div class="navbar">
                <ul class="nav">
