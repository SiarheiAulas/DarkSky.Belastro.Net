<aside id="filtersAside">
	...
	<div class="legend">
		<div><img src="{{asset('img/3r.png')}}"> Группа Infinity</div>
		<div><img src="{{asset('img/2r.png')}}"> Клуб hv</div>
		<div><img src="{{asset('img/6r.png')}}"> Виктор Жук</div>
		<div><img src="{{asset('img/4r.png')}}"> Группа Betelgeise</div>
	</div>
	<div>
		<div><img src="{{asset('img/1r.png')}}"> Клуб Cirrus</div>
		<div><img src="{{asset('img/5r.png')}}"> Иван Прокопюк</div>
		<div><img src="{{asset('img/7r.png')}}"> Обсерватории</div>
		<div><img src="{{asset('img/8r.png')}}"> Astroplaces</div>
	</div>
    </div>
